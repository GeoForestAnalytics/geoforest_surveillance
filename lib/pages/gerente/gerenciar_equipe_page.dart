// lib/pages/gerente/gerenciar_equipe_page.dart
...
class _GerenciarEquipePageState extends State<GerenciarEquipePage> {
  ...
  Future<void> _revogarAcesso(String uid, String nomeMembro) async {
    final bool? confirmar = await showDialog<bool>(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: Text("Tem certeza que deseja remover o agente '$nomeMembro' da sua equipe? Ele perderá o acesso imediatamente."),
        actions: [
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: const Text('Gerenciar Equipe de Agentes')),
      ...
      floatingActionButton: FloatingActionButton.extended(
        onPressed: () {
          Navigator.push(context, MaterialPageRoute(builder: (context) => const FormMembroEquipePage()));
        },
