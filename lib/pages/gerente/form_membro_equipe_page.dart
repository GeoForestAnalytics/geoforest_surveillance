...
class _FormMembroEquipePageState extends State<FormMembroEquipePage> {
  ...
  String _cargoSelecionado = 'equipe'; // 'equipe' para Agente de Campo
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Adicionar Agente')),
          ...
          child: Column(
            ...
            children: [
              ...
              DropdownButtonFormField<String>(
                ...
                items: const [
                  DropdownMenuItem(value: 'equipe', child: Text('Agente de Campo')),
                  DropdownMenuItem(value: 'gerente', child: Text('Gerente (Admin)')),
                ],
                onChanged: (value) {
              ...
              ElevatedButton.icon(
                ...
                label: Text(_isLoading ? 'Adicionando...' : 'Adicionar Agente'),
