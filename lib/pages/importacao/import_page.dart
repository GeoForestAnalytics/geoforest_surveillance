                ...
                child: Column(
                  ...
                  children: [
                    TextFormField(
                      ...
                      decoration: const InputDecoration(labelText: 'Nome da Campanha', border: OutlineInputBorder(), prefixIcon: Icon(Icons.campaign_outlined)),
                      validator: (v) => v!.trim().isEmpty ? 'Campo obrigatório' : null,
                    ),
                    const SizedBox(height: 16),
                    TextFormField(
                      controller: _orgaoController,
                      decoration: const InputDecoration(labelText: 'Órgão Responsável', border: OutlineInputBorder(), prefixIcon: Icon(Icons.corporate_fare_outlined)),
                      validator: (v) => v!.trim().isEmpty ? 'Campo obrigatório' : null,
                    ),
                    const SizedBox(height: 16),
                    TextFormField(
                      controller: _nomeAcaoController,
                      decoration: const InputDecoration(labelText: 'Nome da Ação/Ciclo Padrão', border: OutlineInputBorder(), prefixIcon: Icon(Icons.directions_walk_outlined)),
                      validator: (v) => v!.trim().isEmpty ? 'Campo obrigatório' : null,
                    ),
                    const SizedBox(height: 16),
                    TextFormField(
                      ...
                      decoration: const InputDecoration(labelText: 'ID do Município (Código IBGE)', border: OutlineInputBorder(), prefixIcon: Icon(Icons.pin_outlined)),
                       validator: (v) => v!.trim().isEmpty ? 'Campo obrigatório' : null,
                    ),
                    const SizedBox(height: 16),
                    // =======================================================
                    ...
                    TextFormField(
                      ...
                      decoration: const InputDecoration(labelText: 'UF do Município', border: OutlineInputBorder(), prefixIcon: Icon(Icons.public_outlined), counterText: ""),
                    ...
                    if (_selectedFile == null)
                      const Padding(
                        ...
                        child: Text('Nenhum arquivo selecionado.', style: TextStyle(color: Colors.red), textAlign: TextAlign.center),
                      ),
                    ...
                    ElevatedButton.icon(
                      onPressed: () async {
                        if (_formKey.currentState!.validate() && _selectedFile != null) {
                          final bool sucesso = await controller.processarImportacao(
                            ...
                            municipioIdPadrao: _municipioIdController.text.trim(),
                            // =======================================================
                          ...
                          if (sucesso && mounted) {
                            ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text('Campanha e setores importados com sucesso!'), backgroundColor: Colors.green,));
                            Navigator.pop(context, true); // Retorna 'true' para a página anterior recarregar a lista
                          }
